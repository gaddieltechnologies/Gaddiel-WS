<?php die("Access Denied"); ?>#x#a:2:{s:6:"output";s:0:"";s:6:"result";s:261086:"/* Compiled Less CSS File */
...
[class*=" icon-"] {
  ...
  background-image: url(/templates/it_zen/assets/img/glyphicons-halflings.png);
...
.dropdown-submenu:hover > a > [class*=" icon-"],
.dropdown-submenu:focus > a > [class*=" icon-"] {
  background-image: url(/templates/it_zen/assets/img/glyphicons-halflings-white.png);
}
.icon-glass {
...
ul.ice-check li {
  background-image: url(/templates/it_zen/assets/images/typo_check.png);
}
ul.ice-arrow li {
  background-image: url(/templates/it_zen/assets/images/typo_arrow.png);
}
ul.ice-cross li {
  background-image: url(/templates/it_zen/assets/images/typo_cross.png);
}
ul.ice-light li {
  background-image: url(/templates/it_zen/assets/images/typo_light.png);
}
ul.ice-star li {
  background-image: url(/templates/it_zen/assets/images/typo_star.png);
}
ul.ice-note li {
  background-image: url(/templates/it_zen/assets/images/typo_note.png);
}
ul.ice-check2 li {
  background-image: url(/templates/it_zen/assets/images/typo_check2.png);
}
ul.ice-help li {
  background-image: url(/templates/it_zen/assets/images/typo_help.png);
}
ul.ice-info li {
  background-image: url(/templates/it_zen/assets/images/typo_info.png);
}
blockquote {
  border: none;
  text-align: left;
...
p.notice {
  color: #514721;
  background: #fff6bf url(/templates/it_zen/assets/images/typo_note.png) no-repeat 10px center;
  border: 1px solid #FFDE24;
}
div.success,
p.success {
  color: #264409;
  background: #e6efc2 url(/templates/it_zen/assets/images/typo_success.png) no-repeat 10px center;
  border: 1px solid #CEE086;
}
div.error,
p.error {
  color: #8A1F11;
  background: #fbe3e4 url(/templates/it_zen/assets/images/typo_error.png) no-repeat 10px center;
...
@font-face {
  ...
  src: url(/templates/it_zen/assets/fonts/MonoSocialIconsFont-1.10.eot);
  src: url(/templates/it_zen/assets/fonts/MonoSocialIconsFont-1.10.eot) format('embedded-opentype'), url(/templates/it_zen/assets/fonts/MonoSocialIconsFont-1.10.woff) format('woff'), url(/templates/it_zen/assets/fonts/MonoSocialIconsFont-1.10.ttf) format('truetype'), url(/templates/it_zen/assets/fonts/MonoSocialIconsFont-1.10.svg) format('svg');
  src: url(/templates/it_zen/assets/fonts/MonoSocialIconsFont-1.10.ttf) format('truetype');
  font-weight: normal;
  font-style: normal;
}
.symbol,
...
body.contentpane .mailto-close a {
  background: #81ac00 url(/templates/it_zen/assets/images/system/icon_close.png) no-repeat center;
  font-size: 20px;
  font-weight: normal;
  line-height: 20px;
  color: #fff;
...
#slideshow .camera_next span {
  background: url(/templates/it_zen/assets/images/slideshow_arrows.png);
  width: 55px;
  height: 40px;
  -webkit-transition: all 0.2s ease-out;
  -moz-transition: all 0.2s ease-out;
...
#footer input[type="email"] {
  background-image: url(/templates/it_zen/assets/images/icon_email.png);
  background-repeat: no-repeat;
...
#testimonials.owl-theme .owl-controls .owl-buttons div {
  ...
  background-image: url(/templates/it_zen/assets/images/showcase_arrows.png);
  background-repeat: no-repeat;
...
#gotop .scrollup:after {
  ...
  left: 0;
  position: absolute;
  background-image: url(/templates/it_zen/assets/images/icon_top.png);
  background-repeat: no-repeat;
...
p#icelogo a {
  width: 92px;
  height: 45px;
  background: url(/templates/it_zen/assets/images/icetheme.png) no-repeat;
  display: inline-block;
  margin: 0;
  text-indent: -9999px;
  opacity: .6;
...
#poll_comp_form div#poll_loading_1 {
  background: url(/templates/it_zen/assets/images/mijopoll_loading.gif) no-repeat center left;
  height: 38px;
...
#pageslide #responsivebar-inner ul.menu > li.parent > a {
  background-image: url(/templates/it_zen/assets/images/icon_plus.png);
  background-position: 98% center;
  background-repeat: no-repeat;
}
#pageslide #responsivebar-inner ul.menu > li.parent.active > a {
  background-image: url(/templates/it_zen/assets/images/icon_minus.png);
  background-position: 98% center;
  background-repeat: no-repeat;
}
#pageslide #responsivebar-inner ul.menu li.parent ul.dropdown-menu {
...
#header .search_icon {
  ...
  width: 25px;
  height: 25px;
  background: url(/templates/it_zen/assets/images/icon_search.png) no-repeat center;
  margin: 0;
  vertical-align: middle;
  opacity: .75;
  -webkit-transition: all 0.2s ease-out;
