...
class com_imagerecycleInstallerScript{
		 ...
		 */
			...
			<div class="main-presentation" style="margin: 0px auto; max-width: 1200px; background-color:#f0f1f4;font-family: helvetica,arial,sans-      serif;">
				<div class="main-textcontent" style="margin: 0px auto; border-left: 0px dotted #d2d3d5; border-right: 0px dotted #d2d3d5; width:          840px; background-color:#fff;border-top: 5px solid #544766;" cellspacing="0" cellpadding="0" align="center">
					...
					<p style="background-color: #ffffff; color: #445566; font-family: helvetica,arial,sans-serif; font-size: 24px; line-height: 24px; padding-right: 10px; padding-left: 10px;" align="center"><strong><?php echo JText::_('COM_IMAGERECYCLE_INSTALLER_WELCOME');?><br></strong></p>  
			
					<a style="width: 200px; height: 35px; background: #554766; font-size: 12px; line-height: 18px; text-align: center; margin-right:4px;color: #fff;font-size: 14px;text-decoration: none; text-transform: uppercase; padding: 8px 20px;font-weight:bold;" href="index.php?option=com_imagerecycle" ><?php echo JText::_('COM_IMAGERECYCLE_INSTALLER_GOTO');?></a>
					<p><br/><br/></p>
				</div>
			</div>
    ...
    //                        JFile::delete(JPATH_ADMINISTRATOR.'/components/com_sponsorshipreward/extensions/'.$folder);
                          //  echo '<img src="'. JURI::root().'/components/com_imagerecycle/assets/images/tick.png" />'.$folder.' : '.JText::sprintf('COM_IMAGERECYCLE_INSTALLER_EXT_OK','').'<br/>';
                        }else{
